---
title: "Zambia - PTI - Metadata for underlining datasets"
author: "Eduard Bukin"
...
mtdt_path <- here::here("app-data", "metadata-2021-06-28.xlsx")
bond_path <- here::here("app-shapes", "shapes.rds")
...
pkgload::load_all(path = here::here("."), export_all = FALSE, helpers = FALSE, 
                  attach_testthat = FALSE)
source(here("R", "supporting-goe-prep.R"))
# source(here("R", "fct_legend_map_satelites_copy.R"))
...
one_section <-
  function(meta_line,
    ...
    if (nchar(meta_line$var_description) > 10)
      cat("**Description:** ", meta_line$var_description, "\n\n\n")
    
    var_to_plot_raw <- plot_data[[meta_line$spatial_level]] %>%
      select(contains(meta_line$spatial_level),
             one_of(meta_line$var_code))
